...
# i-SAIRAS 2026 abstract — opportunity (decision pending)

**Tracked, not started** (per 16/06 — no abstract drafting yet). The decentralised algorithm paper (the Q3 wedge headline, see `1-fleeting/2026-06-09 Summer high-agency ideas — generation rounds.md` workstream B) has a possible home: the i-SAIRAS 2026 abstract deadline was extended to **24 June 2026**.

## The facts
- **Conference:** Joint i-SAIRAS & iSpaRo 2026, **Cologne, 3-6 Nov 2026.** IEEE peer-reviewed, IEEE Xplore proceedings. THE space robotics/AI/automation conference — run by/attended by the agencies + ISAM companies in the founding brief (ESA-hosted; DLR on the doorstep).
- **Two tracks, same date, different commitment:**
  - **i-SAIRAS = abstract** (via conference website) by 24/06 — LOW upfront cost; full paper/presentation later if accepted. **This is the route.**
