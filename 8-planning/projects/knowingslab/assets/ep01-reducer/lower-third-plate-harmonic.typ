...
//   LABEL = "PLATE HARMONIC",       STATE = "NEW DESIGN"
...
// ------------ Edit per shot ------------
#let LABEL = "PLATE HARMONIC"
#let STATE = "NEW DESIGN"
#let STATE-COLOUR = ks-accent  // ks-accent (gold) / ks-accent-cool (teal) / ks-accent-warn (red)
// ---------------------------------------
